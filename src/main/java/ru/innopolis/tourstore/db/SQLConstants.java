...
public class SQLConstants {
    ...
    public static final String CREATE_TABLE_USERS_QUERY = "CREATE TABLE IF NOT EXISTS USERS (ID INTEGER AUTO_INCREMENT PRIMARY KEY, NAME VARCHAR(50), PASSWORD VARCHAR(50), SALT VARCHAR(10), ROLE VARCHAR(10) );";
    ...
    public static final String INSERT_USER_QUERY = "INSERT INTO USERS (NAME, PASSWORD, SALT, ROLE) VALUES (?,?,?,?);";
    ...
    public static final String UPDATE_USER_QUERY = "UPDATE USERS SET NAME=?, PASSWORD=?, SALT=?, ROLE=? WHERE ID=?";
