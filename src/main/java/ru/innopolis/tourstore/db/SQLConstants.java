...
public class SQLConstants {
    ...
    public static final String DATABASE_URL_H2_TEST = "jdbc:h2:~/tourstoretest";

    public static final String DROP_ALL_QUERY = "DROP ALL OBJECTS;";

    public static final String CREATE_TABLE_USERS_QUERY = "CREATE TABLE IF NOT EXISTS USERS (ID INTEGER AUTO_INCREMENT PRIMARY KEY, NAME VARCHAR(50), PASSWORD VARCHAR(100), ENABLED BOOLEAN, ROLE VARCHAR(10) );";
    ...
    public static final String INSERT_USER_QUERY = "INSERT INTO USERS (NAME, PASSWORD, ENABLED, ROLE) VALUES (?,?,?,?);";
    ...
    public static final String SELECT_USER_BY_NAME_QUERY = "SELECT * FROM USERS WHERE NAME=?";

    public static final String UPDATE_TOUR_QUERY = "UPDATE TOURS SET NAME=?, DESCRIPTION=?, DELETED=? WHERE ID=?";
    public static final String UPDATE_USER_QUERY = "UPDATE USERS SET NAME=?, PASSWORD=?, ENABLED=?, ROLE=? WHERE ID=?";
